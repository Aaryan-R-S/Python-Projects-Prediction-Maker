...
<p align="center">
  ...
  <h3 align="center">Prediction Maker</h3>
...
This is a python app which can analyse any dataset for inputs and outputs and then predict the possible outputs for given correspoding inputs using sklearn. It is a great utility which I prefer to quickly get glimpse of any large dataset.
...
- Clone the repo
   ```sh
   git clone https://github.com/Aaryan-R-S/Python-Projects-Prediction-Maker.git
   ```
- Python Modules
  - `pip install sklearn` 
